  ...
  return (
    <div className="p-3 xs:p-4 sm:p-6 space-y-4 max-w-[1600px] mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-lg sm:text-xl font-bold text-white">Employés</h1>
        ...
        <div className="grid grid-cols-2 gap-2 sm:flex">
          <button
            ...
            className="px-3 sm:px-4 py-2 rounded-lg text-white text-xs sm:text-sm font-semibold transition flex items-center justify-center gap-2"
