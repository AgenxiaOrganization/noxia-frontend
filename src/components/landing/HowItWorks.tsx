    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 id="how-it-works-title" className="text-3xl sm:text-4xl font-bold mb-4 text-white">
            Comment ça marche ?
          </h2>
        ...
        <div 
          ...
          role="list"
          aria-label="Étapes d'activation de NOXIA"
        >
          {steps.map((step) => (
            <div key={step.number} className="text-center" role="listitem">
              <div 
